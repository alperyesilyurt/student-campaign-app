export const tableColumnsTopCreators = [
  ...
  },
  {
    name: [
      "15% Ayakkabılarda indirim",
      ,
      "https://cdn.shopify.com/s/files/1/2162/9631/files/6._Style_Quiz_Options_314x494_2.jpg?v=1662979165&width=157",
    ],
    clickCount: 3871,
    clickToUsageRate: 55,
  },
  {
    name: [
      "15% Ayakkabılarda indirim",
      ,
      "https://i.ibb.co/NSJYQYD/Horizon-UI-Avatar.png",
    ],
    clickCount: 3152,
    clickToUsageRate: 46,
  },
